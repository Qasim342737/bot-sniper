...
//   const quoteUrl = `${AdPI_HOST}/defi/router/v1/sol/tx/get_swap_route?token_in_address=${inputToken}&token_out_address=${outputToken}&in_amount=${thresholds.tradeAmount}&from_address=${fromAddress}&slippage=${slippage}`
